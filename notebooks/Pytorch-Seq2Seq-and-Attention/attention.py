...
# DEBUG: Convert unicode into ASCII
...
# DEBUG: helper method for training process
import time
import math
...
# DEBUG: save encoder and attn_decoder
torch.save(encoder1, 'encoder1.ckpt')
torch.save(attn_decoder1, 'attn_decoder1.ckpt')


# DEBUG: visualizing attention
